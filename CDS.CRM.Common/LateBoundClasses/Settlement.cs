...
// Filename   : D:\Techxacts Training\LateBound\Settlement.cs
...
namespace CDS.CRM.Common
{
    ...
    {
        public const string EntityName = "cdi_settlement";
        public const string EntityCollectionName = "cdi_settlements";
    }
}
